...
- [苏格拉底模式](/ReadAny/zh/support/socratic-mode/)
- [微评系统](/ReadAny/zh/support/mini-reviews/)
- [预热策略](/ReadAny/zh/support/preheating-strategy/)
...
<Card title="高级功能" icon="gear">
探索高级功能和自定义选项。

- [图书馆管理](/ReadAny/zh/support/library-management/)
- [键盘快捷键](/ReadAny/zh/support/keyboard-shortcuts/)
- [移动端应用指南](/ReadAny/zh/support/mobile-guide/)
- [隐私与安全](/ReadAny/zh/support/privacy-security/)
- [故障排除](/ReadAny/zh/support/troubleshooting/)
</Card>
</CardGrid>
